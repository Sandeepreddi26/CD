...
client=pymongo.MongoClient("mongodb+srv://sandeepreddy26:Sandeep2003@cluster0.8n4gtrf.mongodb.net/?retryWrites=true&w=majority")
db=client["Farmers"]
...
def main():
    if request.method=="POST":
        if request.form.get("buttons")=="login":
...
def detect():
    if request.method=="POST":
        ...
        file_path=os.path.join(r'D:/CropDoctor/static',filename)
        file.save(file_path)
